    ...
    <LegalPage title="Privacy Policy">
      ...
      <Section heading="What we collect">
        ...
        <ul className="list-disc pl-5 space-y-1.5">
          ...
          <li><strong className="text-slate-900 font-semibold">Your searches</strong> — the keyword and which job sites you searched. Used to enforce daily limits and to run your alerts.</li>
          ...
          <li><strong className="text-slate-900 font-semibold">Your alert settings</strong> — keyword, filters, and the job links already emailed to you, so we do not repeat them.</li>
      ...
      <Section heading="Who else sees your data">
        ...
        <ul className="list-disc pl-5 space-y-1.5">
          ...
          <li><strong className="text-slate-900 font-semibold">Gmail / SMTP</strong> — sends your alert emails.</li>
        </ul>
        <p>
      ...
      <Section heading="How long we keep it">
        <p>
          ...
          is deleted with it — searches, saved jobs, career profile, alerts, and any
