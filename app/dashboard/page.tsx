            ...
            <div className="flex-1 flex flex-col min-h-0 overflow-hidden animate-fade-in">
              ...
              {!result.isLiveData && (
                <div className="shrink-0 flex items-center gap-2 px-4 py-2 bg-yellow-500/10 border-b border-yellow-500/20 text-xs text-yellow-400">
                  ...
                  <span><strong>Demo mode</strong> — showing sample jobs. Set <code className="bg-yellow-500/20 px-1 rounded">DEMO_MODE=false</code> and add a valid <code className="bg-yellow-500/20 px-1 rounded">ONLINEJOBS_SESSION_COOKIE</code> in Vercel env vars for live data.</span>
                </div>
              )}
